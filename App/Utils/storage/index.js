 ...
 * let user = {}
 * user.name = 'chenliang'
 * storage.save('userTest', user)
 * storage.load('userTest', data => {
 *   alert(data.name)
 * })
 * ps:storage已经设为全局变量，可直接使用
 */
...
let defaultExpires = 1000 * 3600 * 24; // 数据过期时间,默认一整天（1000 * 3600 * 24 毫秒）
let size = 1000;
